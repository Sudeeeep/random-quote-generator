        ...
        <div className="mx-auto flex flex-col gap-12 mt-12 pb-10 sm:w-1/2">
          ...
          >
            <div>
              ...
              <p className="text-sm text-[#828282] font-medium"></p>
            </div>
  ...
  return (
    <>
      <div className="mx-auto flex flex-col gap-12 mt-12 pb-10 sm:w-1/2">
        ...
        <div
          onClick={() => setIsAuthorSelected(true)}
          className="flex justify-between items-center ml-10 px-2 py-6 transition hover:bg-[#333333] hover:text-white cursor-pointer"
        >
          <div>
